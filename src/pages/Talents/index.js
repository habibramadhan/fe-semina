...
export default function TalentsPage() {
    ...
    const getAPITalents = async () => {
        ...
        const res = await debounceFetchTalents('/v1/cms/talents', params);
    ...
    <Container>
        ...
        <SButton className='mb-3' action={() => navigate('/talents/create')}>Tambah</SButton>
      ...
      <tbody>
        ...
        <tr key={index}>
            ...
            <td>
            <SButton size='sm' variant='success' action={() => navigate(`/talents/edit/${data._id}`)}>
                Edit
            </SButton>
